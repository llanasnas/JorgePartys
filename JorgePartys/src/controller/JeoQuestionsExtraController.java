...
public class JeoQuestionsExtraController implements ActionListener{
    ...
    private PreguntaExtra model;
    private JeoQuestions view;
    private JeoController controller;

    public JeoQuestionsExtraController(PreguntaExtra model, JeoQuestions view, JeoController controller) {
        this.model = model;
        this.view = view;
    ...
    public void setUpButtons() {
        ...
        view.pregunta.setText(this.model.getPregunta_extra());
